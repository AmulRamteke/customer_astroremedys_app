...
class ThemeController extends GetxController implements GetxService {
  ...
  int pickColorInt = 0xffea6c10;
  //0xffea6c10
  Color _pickColor = Color(0xffea6c10);
  Color get pickColor => _pickColor;

  Color _pickSecondaryColor = Color(0xffea6c10);
  ...
  void _loadCurrentTheme() async {
    ...
    if (global.sp!.getInt('primaryColor') != null) {
      ...
      _pickColor = Color(0xffea6c10);
      _pickSecondaryColor = Color(0xffea6c10);
